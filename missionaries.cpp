...
enum treenode{Fail, Incomplete, Goal};
...
int main(){
    ...
    cout<<"\nThe Final Tree is:"<< endl;
    for(int i=0; i<result.size();i++){
        cout<<"        Side 1                    Side 2"<<endl;
        cout<< "M: " << 3-result[i].m << " C: " << 3-result[i].c << " Boat Side: " << result[i].b<< "  |  ";
        cout<< "M: " << result[i].m << " C: " << result[i].c << " Boat Side: " << result[i].b<< endl;
    } 
...
void printNode(treenode node, int limit){
    ...
    switch (node){
        case Fail:
            cout<<"Fail.. no solution was found"<< endl;
            break;
        case Incomplete:
            cout<<"Incomplete.. keep looking"<< endl;
            break;
        case Goal:
            cout<<"You made it! All three missionaries and cannibals crossed the river!"<< endl;
            break;
        default:
            break;
    }
